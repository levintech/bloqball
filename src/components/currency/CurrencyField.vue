<template>
    <div class="root">
        ...
        <div class="root__item">
            <!-- <input type="text" placeholder="0.0" :disabled="readonly" @input="$emit('input',$event.target.value)" :value="value"/> -->
            <q-input :class="['input-text',focused?'focused':'']" 
                standout="bg-white text-white" type="text" placeholder="0.0" :disable="readonly" 
                ...
                <template v-slot:prepend>
                    <div>
                        <q-btn rounded outline color="gray" size="sm" @click="setMax">
                            MAX
                        </q-btn>
                    </div>
                </template>
...
<style scoped>
    /* .root__item .q-field--error .q-field__bottom {
