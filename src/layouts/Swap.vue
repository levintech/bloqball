    ...
    <q-layout view="hhh lpR fFf"
        ...
        <q-header bordered class="bg-transparent text-white">
            <q-toolbar style="height: 80px">
                ...
                <q-btn v-if="!isMobile && isMetaMaskInstalled && !isMetaMaskConnected" rounded label="Connect wallet" unelevated
                       class="q-mx-md gradient-blue" @click="connectWallet"/>
                <q-btn v-if="!isMobile && isMetaMaskInstalled && isMetaMaskConnected" rounded label="Lock wallet" unelevated
                       class="q-mx-md gradient-red" @click="lockMetamask"/>
