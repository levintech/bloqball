            ...
            <div class="card">
                <div class="card__item">
                    <div class="tabs">
                        ...
                        <div class="tab">
                            <button :class=" tab === 'liquidity' ? 'active': ''" @click="tab = 'liquidity'">Liquidity
                            </button>
                        </div>
                    </div>
                    <div class="action">
                        <div class="action__item">
                            <q-btn :label="fee" flat rounded icon="local_gas_station" color="green"/>
                                ...
                                <q-menu anchor="bottom end" self="top right"
                                    ...
                                    <div class="menu">
                                        <div class="menu__item">
                                            <div style="font-size: 1rem">Transaction Settings</div>
                                        </div>
                                        <div class="menu__item">
                                            <div class="title">Slippage tolerance
                                                <q-badge color="grey" rounded>?</q-badge>
                                            </div>
                                            <div>
                                                <div style="display: inline; margin-right: 10px;">
                                                    <input type="text" class="input input--border" v-model="settings.slippage"><span
                                        ...
                                        <div class="menu__item">
                                            <div class="title">Transaction deadline
                                                <q-badge color="grey" rounded>?</q-badge>
                                            </div>
                                            <div>
                                                <input type="text" class="input" style="width: 100px" v-model="settings.deadline"> <span
                                                    style="padding: 10px;">minites</span>
                                            </div>
                                        </div>
                                        <div class="menu__item">
                ...
                <div class="card__item">
                    <Swap @set-fee="fee = $event" v-if="tab === 'swap'"/>
                    <Liquidity @set-fee="fee = $event" v-if="tab === 'liquidity'"/>
                </div>
            </div>
